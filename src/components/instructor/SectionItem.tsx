  ...
  {!showActionButtons ? (
    ...
    <div className="relative">
      ...
      <button 
        ...
        className="absolute -top-6 cursor-pointer -left-2 w-6 h-6 rounded-full flex items-center justify-center text-gray-500 hover:text-gray-700 z-10"
      >
      ...
      {/* Action Buttons */}
      <div className="bg-white border-inset border border-gray-200 rounded-md">
        <ActionButtons
          sectionId={section.id}
