...
const QuizItem: React.FC<QuizItemProps> = ({
  ...
  const [questions, setQuestions] = useState<Question[]>(lecture.questions || []);
        ...
        {showQuestionTypeSelector && (
          <div className="p-3 border-t relative">
            <div className="absolute top-0 right-0 p-2">
              <button onClick={() => setShowQuestionTypeSelector(false)} className="text-gray-500 hover:text-gray-700">
                <X className="w-4 h-4" />
              </button>
            </div>
            <div className="text-center">
              <h3 className="text-sm text-gray-500 mb-2">Select question type</h3>
