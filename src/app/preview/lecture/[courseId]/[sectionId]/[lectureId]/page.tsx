    ...
    <div className="bg-white min-h-screen">
      {sections && sectionId && lectureId ? (
        (() => {
          ...
          const currentLecture = currentSection.lectures?.find(
          ...
          const currentQuiz = currentSection.quiz?.find(
            (q) => String(q.id) === String(lectureId)
          );
            ...
            selectedVideoDetails: currentLecture.videoUrl
              ? {
                  ...
                  duration: currentLecture.duration
                    ? String(currentLecture.duration)
                    : "",
                }
              : null,
          ...
          const isVideoLecture =
            !!currentLecture.videoUrl && currentLecture.videoUrl.trim() !== "";
            ...
            <AssignmentProvider initialData={extendedLecture}>
              <StudentCoursePreview
                ...
                section={{
                  ...
                  codingExercises:
                    (currentSection.codingExercises as any[]) || [],
                }}
